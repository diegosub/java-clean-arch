package br.com.conpact.myspace.infrastructure.api;
...
public interface CategoryAPI {
    ...
    ResponseEntity<CategoryResponse> insert(@RequestBody CreateCategoryRequest input);
    ...
    Pagination<CategoryResponse> listAll(
    ...
    ResponseEntity<CategoryResponse> update(@PathVariable(name = "id") String id, @RequestBody UpdateCategoryRequest input);
